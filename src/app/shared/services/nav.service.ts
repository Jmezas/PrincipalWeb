...
export class NavService {
	...
	MENUITEMS: Menu[] = [
		...
		{
			title: 'categoria', type: 'sub', active: false, children: [
				{ path: '/shop/collection/left/sidebar', title: 'LACTEOS', type: 'link' },
				{ path: '/shop/collection/right/sidebar', title: 'CERIALES', type: 'link' },
				{ path: '/shop/collection/no/sidebar', title: 'GRASAS', type: 'link' },
				{ path: '/shop/collection/infinitescroll', title: 'MENESTRAS', type: 'link' },
				{ path: '/shop/collection/infinitescroll', title: 'LIMPIEZA', type: 'link' },
				{ path: '/shop/collection/infinitescroll', title: 'MASCOTA', type: 'link' }
			]
		},
		{
			title: 'Combinaciones', type: 'sub', active: false, children: [
				// {
		...
		{
			title: 'promociones', type: 'sub', megaMenu: true, badge: true, badgeText: 'new', active: false, children: [
				// {
		...
		{
			title: '¿Necesitas ayuda?', type: 'sub', active: false, children: [
				{
					path: '/pages/wishlist', title: 'whatsapp', type: 'link' 
				}
			]
		},
		...
		// }, 
		{
			title: 'Local', type: 'sub', active: false, children: [
				{ path: '/pages/blog/left/sidebar', title: 'Ubicacion', type: 'link' },
